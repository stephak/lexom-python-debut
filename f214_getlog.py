...
def create_db(path="/Users/stephanehakni/PycharmProjects/dev", file="squidAnonymise.log"):
    path_file = path + os.path.sep + file  # chemin absolu du fichier
    # On crée la base
...
if __name__=="__main__":
    path = "/Users/stephanehakni/PycharmProjects/dev"
    file = "squidAnonymise.log"

    create_db()
    l=get_weird_queries(path,"squidAnonymise.db",10)
    print(l)